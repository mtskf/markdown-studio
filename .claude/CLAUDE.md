...
1. **Force install**: install the latest version of markdown studio. For example:`code --install-extension its-markdown-studio-2.3.13.vsix --force`. Refer Versioning section for more information on when the version changes.
